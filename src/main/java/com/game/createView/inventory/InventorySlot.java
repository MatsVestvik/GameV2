package com.game.createView.inventory;

import com.game.createView.RarityFilter;
...
class InventorySlot {
    ...
    public boolean setItem(Item item) {
        ...
        if (item instanceof Item) {
            ...
            RarityFilter.applyRarityTint(imageView, armourItem.getRarity());
        } else if (item instanceof Item) {
            // If Item class has a tint method
            RarityFilter.applyRarityTint(imageView, item.getRarity());
        }
